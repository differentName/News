    ...
    init(type:ImgType, array:[String])
    {
        ...
        if imgType == .SERVER
        {
            imgArray = array.map({ (urlStr) -> ImgSource in
                if(urlStr == ""){
                    return ImgSource.SERVER(url: URL(string: "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1502945051392&di=b7b70b6e7e80270ce853168ba2cfe9b6&imgtype=0&src=http%3A%2F%2Fpic2.16pic.com%2F00%2F20%2F02%2F16pic_2002642_b.jpg")!)
                }else{
